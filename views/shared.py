...
def render_login(login_fn):
    ...
    # 1. Student card (neutral gray outline)
    with cols[0]:
        st.markdown(f"""
        <div class='card'>
            <div style="margin-bottom: 0.5rem; color: #4B5563;">{icon_svg("user", size=24, color="#4B5563")}</div>
            <h3>Student</h3>
    ...
    # 2. Counselor card (neutral gray outline)
    with cols[1]:
        st.markdown(f"""
        <div class='card'>
            <div style="margin-bottom: 0.5rem; color: #4B5563;">{icon_svg("compass", size=24, color="#4B5563")}</div>
            <h3>Counselor</h3>
    ...
    # 3. Administrator card (neutral gray outline)
    with cols[2]:
        st.markdown(f"""
        <div class='card'>
            <div style="margin-bottom: 0.5rem; color: #4B5563;">{icon_svg("chart", size=24, color="#4B5563")}</div>
            <h3>Administrator</h3>
    ...
    # 4. Anonymous Reporting card (ONLY card with the green accent fill)
    allow_anon = get_setting("allow_anonymous_reports", "1") == "1"
    with cols[3]:
        if allow_anon:
            st.markdown(f"""
            <div class='sb-card-highlight'>
                <div style="margin-bottom: 0.5rem; color: #27500A;">{icon_svg("anonymous", size=24, color="#27500A")}</div>
            ...
            <div class='card' style="opacity: 0.7;">
                <div style="margin-bottom: 0.5rem; color: #9CA3AF;">{icon_svg("anonymous", size=24, color="#9CA3AF")}</div>
                <h3>Anonymous report</h3>
